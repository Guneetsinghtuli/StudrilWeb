      ...
      <div className="flex flex-row m-2 justify-around">
        <div className="bg-white w-96 rounded-lg shadow-lg ">
          <div className="flex flex-row m-4">
            <Image src={Img}></Image>
            <h2 className="text-2xl text-center font-bold mb-4  mb-4 ml-6 mt-4">
              David Anderson
            </h2>
          </div>
          ...
          <div className="text-4xl font-bold text-green-500 mb-2 px-16 py-5">
            <div className="flex flex-row justify-around">
              <div className="bg-white rounded-lg shadow-lg   border-4 border-[#FFC727] r-0 mr-2">
                <h2 className="text-lg text-center font-bold mb-4 bg-[#ffe680] mb-4">
                  Before
                </h2>
              ...
              <div className="bg-white rounded-lg shadow-lg   border-4 border-[#FFC727] ml-2">
          ...
          <div className="flex flex-col m-4 text-center">
             <p className="text-xl">I Love Japan</p>
             <p className="text-xl">私の名 前は バミカ</p>
             <p className="text-xl">Nihon ga suki desu.</p>
          </div>
        </div>
        <div className="bg-white w-96 rounded-lg shadow-lg ">
          <div className="flex flex-row m-4">
