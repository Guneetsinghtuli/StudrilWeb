...
const price = () => {
  return (
    <section className="mt-24 mb-10">
      <div>
        <h1 className="text-center font-bold mb-4 text-[#1E2B5E]     text-3xl pt-100">
          Choose your Investment!
        </h1>
        <h2 className="text-center text-lg font-bold mb-4 text-[#1E2B5E]     ">
      ...
      <div class="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 mt-10">
        ...
        <a href="#" class="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
            ...
            <div class="text-left">
                ...
                <div class="-mt-1   text-sm font-semibold">Google Play</div>
            </div>
        </a>
    </div>
    </section>
