...
<div className="w-full sticky top-0 bg-white py-1 z-50">
    ...
    <div className="container mx-auto flex flex-wrap items-center justify-between m-4 px-8">
        ...
        <button data-collapse-toggle="mobile-menu" type="button" className="md:hidden ml-3 text-gray-400 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-300 rounded-lg inline-flex items-center justify-center='true'" aria-controls="mobile-menu-2" aria-expanded="false">
