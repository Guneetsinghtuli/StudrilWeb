...
const Terms = () => {
  return (
    ...
    {/* Make a small button that takes you back to home */}
        <div className="flex flex-row">
            ...
            <div className="flex flex-row m-3">
                ...
                <p className="text-[#EFCB27] font-bold text-xl">Terms of Service</p>
            </div>  
        </div>
      <h1 className="font-bold">Terms of Service</h1>
      <h2 className="font-bold">OVERVIEW</h2>
      <p className="mx-1 my-3 text-[10px]">
        This website is operated by StuDrill LLC. Throughout the site, the terms
        “we”, “us” and “our” refer to StuDrill LLC. StuDrill LLC offers this
        ...
        GoDaddy Inc. They provide us with building websites, along with hosting,
        email and marketing options to grow our business on the web.
      </p>
      <h2 className="font-bold">SECTION 1 – ONLINE STORE TERMS</h2>
      <p className="mx-1 my-3 text-[10px]">By agreeing to these Terms of Service, you represent that you are
      ...
      <p className="mx-1 my-3 text-[10px]">We reserve the right to refuse service to anyone for any reason at
      ...
      <p className="mx-1 my-3 text-[10px]">We are not responsible if information made available on this site
      ...
      <p className="mx-1 my-3 text-[10px]">Prices for our products are subject to change without notice. We
      reserve the right at any time to modify or discontinue the Service (or any
      ...
      <p className="mx-1 my-3 text-[10px]">Certain products or services may be available exclusively online
      ...
      possible the colors and images of our products that appear at the store.
      We cannot guarantee that your computer monitor’s display of any color will
      be accurate. We reserve the right, but are not obligated, to limit the
      ...
      reserve the right to limit the quantities of any products or services that
      we offer. All descriptions of products or product pricing are subject to
      change at anytime without notice, at the sole discretion of us. We reserve
      ...
      material purchased or obtained by you will meet your expectations, or that
      ...
      <p className="mx-1 my-3 text-[10px]">We reserve the right to refuse any order you place with us. We may,
      ...
      <p className="mx-1 my-3 text-[10px]">We may provide you with access to third-party tools over which we
      ...
      the terms on which tools are provided by the relevant third-party
      ...
      <p className="mx-1 my-3 text-[10px]">Certain content, products and services available via our Service
      may include materials from third-parties. Third-party links on this site
      may direct you to third-party websites that are not affiliated with us. We
      ...
      products, or services of third-parties. We are not liable for any harm or
      ...
      should be directed to the third-party.</p>
      <h2 className="font-bold">SECTION 9 – USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
      <p className="mx-1 my-3 text-[10px]">If, at our request, you send certain specific submissions (for
      example contest entries) or without a request from us you send creative
      ideas, suggestions, proposals, plans, or other materials, whether online,
      by email, by postal mail, or otherwise (collectively, ‘comments’), you
      ...
      <p className="mx-1 my-3 text-[10px]">Your submission of personal information through the store is
      governed by our Privacy Policy. To view our Privacy Policy.</p>
      <h2 className="font-bold">SECTION 11 – ERRORS, INACCURACIES AND OMISSIONS</h2>
      <p className="mx-1 my-3 text-[10px]">Occasionally there may be information on our site or in the Service
      ...
      updated.</p>
      <h2 className="font-bold">SECTION 12 – PROHIBITED USES</h2>
      <p className="mx-1 my-3 text-[10px]">In addition to other prohibitions as set forth in the Terms of
      ...
      <h2 className="font-bold">SECTION 13 – DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
      <p className="mx-1 my-3 text-[10px]">We do not guarantee, represent or warrant that your use of our
      service will be uninterrupted, timely, secure or error-free. We do not
      warrant that the results that may be obtained from the use of the service
      ...
      any time, without notice to you. You expressly agree that your use of, or
      ...
      durability, title, and non-infringement. In no case shall FME, our
      ...
      permitted by law.</p>
      <h2 className="font-bold">SECTION 14 – INDEMNIFICATION</h2>
      <p className="mx-1 my-3 text-[10px]">You agree to indemnify, defend and hold harmless FME and our
      ...
      <h2 className="font-bold">SECTION 15 – SEVERABILITY</h2>
      <p className="mx-1 my-3 text-[10px]">In the event that any provision of these Terms of Service is
      ...
      <h2 className="font-bold">SECTION 16 – TERMINATION</h2>
      <p className="mx-1 my-3 text-[10px]">The obligations and liabilities of the parties incurred prior to
      ...
      or when you cease using our site. If in our sole judgment you fail, or we
      ...
      <h2 className="font-bold">SECTION 17 – ENTIRE AGREEMENT</h2>
      <p className="mx-1 my-3 text-[10px]">The failure of us to exercise or enforce any right or provision of
      ...
      entire agreement and understanding between you and us and govern your use
      ...
      Service). Any ambiguities in the interpretation of these Terms of Service
      shall not be construed against the drafting party.</p>
      <h2 className="font-bold">SECTION 18 – GOVERNING LAW</h2>
      <p className="mx-1 my-3 text-[10px]">These Terms of Service and any separate agreements whereby we
      provide you Services shall be governed by and construed in accordance with
      the law</p>
      <h2 className="font-bold">SECTION 19 – CHANGES TO TERMS OF SERVICE</h2>
      <p className="mx-1 my-3 text-[10px]">You can review the most current version of the Terms of Service at
      ...
      of Service constitutes acceptance of those changes.</p>
      <h2 className="font-bold">SECTION 20 – CONTACT INFORMATION</h2>
      <p className="mx-1 my-3 text-[10px]">
        Questions about the Terms of Service should be sent to us at:
        contact@studrill.com
      </p>
    </div>
  );
};
